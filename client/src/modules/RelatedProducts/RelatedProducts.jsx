  ...
  render () {
    return (
      <div className={style.carosel} data-testid='list'>
        {this.props.relatedInfo.relatedStart !== 0
        ? <button
        ...
        <div className={style.list}>
          {this.props.products.map((product, index) => {
            return <ProductCard
                     key={index + 'related' + product.productDetails[0]}
                     product={product}
                     actionButton={this.openCompare}
        ...
        {!this.state.compare
          ...
          : <CompareProducts
              ...
              currentProduct={this.props.relatedInfo.currentProduct}
              compareProduct={this.state.compareProduct}
              data-testid='compareProducts'
            />}
        {this.props.relatedInfo.relatedEnd < this.props.relatedInfo.relatedList.length
          ? <button
              className={btnStyle.nav}
